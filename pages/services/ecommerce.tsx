...
const EcommercePage: NextPage = () => {
  return (
    <div className="min-h-screen bg-white">
      <Head>
        <title>E-commerce Solutions | BrandBoosters</title>
        <meta name="description" content="Comprehensive e-commerce solutions to grow your online store and increase sales" />
      </Head>
